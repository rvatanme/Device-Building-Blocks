...
![](https://github.com/rvatanme/Device-Building-Blocks/blob/main/pn_junctions/tunneling.png)


![](https://latex.codecogs.com/svg.latex?%5CLARGE%20J_t%20%3D%20%5Cfrac%7B%5Csqrt%7B2m%5E*%7Dq%5E3%5Cxi%20V_R%7D%7B4%5Cpi%20%5E2%20%5Chbar%20%5E%202%5Csqrt%7BE_g%7D%7Dexp%28-%5Cfrac%7B4%5Csqrt%7B2m%5E*%7DE_g%5E%7B3/2%7D%7D%7B3q%5Cxi%20%5Chbar%20%5Cxi%7D%29)


When the field approaches lE6 V/cm in Si, significant current begins to flow by means of this band-to-band tunneling process. To obtain such a high field, the junction must have relatively high impurity concentrations on both the p and n side. The mechanism of breakdown for p-n junctions with breakdown voltages less than about 4Eg/q is due to the tunneling effect. For junctions with breakdown voltages in excess of 6Eg/q, the mechanism is caused by avalanche multiplication.


We first derive the basic ionization integral which determines the breakdown condition under impact ionization. Assume that a current I<sub>p0</sub> is incident at the left-hand side of the depletion region with width W<sub>Dm</sub>. If the electric field in the depletion region is high enough that electron-hole pairs are generated by the impact ionization process, the hole current Ip will increase with distance through the depletion region and reach a value M<sub>p</sub>I<sub>p0</sub> at x = W<sub>Dm</sub>. Similarly, the electron current I<sub>n</sub> will increase from
